...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        target_attack = opponent_card.attack
        target_defence = opponent_card.defense
        for card in player.deck.cards:
            card.attack += target_attack
            card.defense += target_defence
        copy = opponent.deck.cards[:]
        for card in copy:
            if card.attack == target_attack or card.defense == target_defence:
