...
class Account:
    ...
    def withdraw(self, amount):
        ...
        if self.balance >= amount:
            ...
            self.transactions += [('withdraw', balance)]
            self.balance = 0 
            return self.balance
    ...
    def __repr__(self):
        depo = 0
        wtdr = 0
        for x, y in self.transactions:
            if x == 'deposit':
                depo += 1
            if x == 'withdraw':
                wtdr += 1
        return f'Accountholder: {self.holder}, Deposits: {depo}, Withdraws: {wtdr}'
